...
MessageSequenceDescriptions.pdf
UseCaseDiagram.pdf
CommunicationDiagrams.pdf (or SequenceDiagrams.pdf)
...
 Message sequence descriptions for each use case must be included.
 Communication diagrams or sequence diagrams for each use case must be included.
